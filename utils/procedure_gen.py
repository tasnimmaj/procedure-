...
MAX_PROCEDURE_ROWS = 55    # Nombre maximum de lignes pour la procédure générée
# --- Modèles disponibles ---
MODELS = {
    "mistral-saba-24b": {
...
3. Des **scénarios détaillés** pour la validation de la procédure (OK/KO)
...
# FORMAT DE SORTIE ATTENDU - SUIVRE STRICTEMENT CE FORMAT
1. Tableau des étapes (obligatoire) :
| N° | Activités | Description | Acteurs | Documents | Applications |
| --- | --- | --- | --- | --- | --- |
[Insérer {min_rows} à {max_rows} lignes]

2. Tableau Entrées/Sorties (obligatoire) :
| Evènement | Processus en interface | Description du processus en interface |
| --- | --- | --- |
| Entrée | [processus initial] | [description détaillée de l'entrée] |
| Sortie | [processus final] | [description détaillée de la sortie] |

3. Scénarios (obligatoires) :
## Scénario OK / Nominal
[Description détaillée du scénario nominal où tout fonctionne correctement]

## Scénario KO / Alternatif
[Description détaillée du scénario d'échec avec points de contrôle non validés]
